...
function TodoCard({ title, deleteTodo, id, item, completeTodo }) {
  ...
  return (
    <div className='flex' style={{ background: "rgba(77,1,100, 0.05)", borderRadius: "10px", border: "solid 1px 0px 0px 4px rgba(77,1,100, 0.4)", color: 'black', padding: "20px", margin: "20px" }}>
